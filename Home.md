...
(https://github.com/springframeworkguru/spring5webapp/wiki#the-tomcat-connector-configured-to-listen-on-port-8080-failed-to-start-the-port-may-already-be-in-use-or-the-connector-may-be-misconfigured)
